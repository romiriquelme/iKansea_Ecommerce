                ...
                @endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name" id="pname">@if(Session::get('language') == 'ind'){{$products->product_name_ind}}@else{{$products->product_name_en}}@endif</h1>
							...
							<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value">{{$products->product_qty}}</span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div><!-- /.stock-container -->
							...
							<div class="description-container m-t-20">
								@if(Session::get('language') == 'ind'){{$products->short_desc_ind}}@else{{$products->short_desc_en}}@endif
                                ...
                                @endphp
									<div class="col-sm-6">
										<div class="price-box">
                                            ...
                                            @else
											<span class="price">{{$products->selling_price}}</span>
											<span class="price-strike">{{$products->discount_price}}</span>
                                            @endif
										</div>
									</div>
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">@if(Session::get('language') == 'ind'){!!{$products->long_desc_ind}}@else{!!{$products->long_desc_en}}@endif</p>
									</div>	
								</div><!-- /.tab-pane -->
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="{{ url('/detail/'. $product->id. '/'.$product->product_slug_en) }}"><img  src="{{ asset($product->product_thumbnail) }}" alt=""></a>
			</div><!-- /.image -->			
