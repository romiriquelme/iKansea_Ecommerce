            ...
            @csrf
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" name="password"  class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password" autocomplete="current-password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
